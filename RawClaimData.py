...
class RawClaimData():
  ...
  def frequent_claimant_analysis(self, export=True, sub_policy=None):
    ...
    days['days_cover'] = (days['discharge_date'] - days['incur_date']).dt.days
    ...
    self.ip_usage_incurred = pd.merge(left=self.ip_usage_incurred, right=days_cover, left_index=True, right_index=True, how='left')
