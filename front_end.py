  ...
  if st.session_state.mcr_convert_uploaded == True:
    ...
    with mcr_convert_year_cofig_col1:
      ...
      previous_year = st.selectbox('Year',
                   ...
                   index=None,
                   key='prev_year')
      previous_year_start_date = str((st.date_input('Start Date', key='prev_year_start_date', format="%d/%m/%Y")))
      previous_year_end_date = str((st.date_input('End Date', key='prev_year_end_date', format="%d/%m/%Y")))
    ...
    with mcr_convert_year_cofig_col2:
      ...
      current_year = st.selectbox('Year',
                          ...
                          index=None,
                          key='current_year')
      current_year_start_date = str(st.date_input('Start Date', key='current_year_start_date', format="%d/%m/%Y"))
      current_year_end_date = str(st.date_input('End Date', key='current_year_end_date', format="%d/%m/%Y"))
